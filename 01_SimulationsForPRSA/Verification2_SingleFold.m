...
modelMechanicalConstant{5}=[1;1;]*500*10^(-6); 
...
modelMechanicalConstant{10}=0.2; 
...
Plot_LoadAndReaction(viewControl,newNode,deformNode,newPanel,load,supp,nodeForce,loadForce);
