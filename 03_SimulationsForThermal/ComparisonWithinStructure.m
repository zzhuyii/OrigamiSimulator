...
ModelConstant{20} = [1;1]; % Thermal Conductivity of panel 
...
ModelConstant{29} = 1; %Thermal Conductivity of crease
ModelConstant{21} = 0; % Thermal Conductivity of submerged environment

ModelConstant{22} = [1;1]*1; % Thickness of the 
% submerged environment at RT for panels
% This value is allowed to be different to consider the anchorage.
ModelConstant{30} = 1; % Thickness of the 
% submerged environment at RT for panels
ModelConstant{31} = 0; % Number of Air layers used
ModelConstant{32} = 30/180*3.14; % Thermal dissipation angle
