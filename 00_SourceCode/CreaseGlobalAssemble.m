...
% This fucntion Calculate the global stiffness matrix from the rotational spring elements
...
function [Kspr]=CreaseGlobalAssemble(U,M,CreaseIJKL,CreaseK,newNode)
A=size(U);
NodeNum=A(1);
...
for i=1:BarNum
    ...
    if CreaseIJKL(i,1)==0   
        ...
        localK=CreaseK(i)*(part*part')+M(i)*part2;
