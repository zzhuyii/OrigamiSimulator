...
function[Tcontact,Kcontact]=Contact_AssembleForceStiffness(...
                ...
                if k==i
                    ...
                    for m=1:Num2                        
                        ...
                        if check==0                           
                            ...
                            [d,zone,N1,N2]=Contact_P2TDistance(Point,T1,T2,T3);                            
                            if d<=d0edge                            
                                if zone==0  
                                    [Dd2x2,Ddx]=Contact_DerivativeZone0(Point,T1,T2,T3);
                                ...
                                elseif zone==1
                                    ...
                                    [Dd2x2,Ddx]=Contact_DerivativeZone1(Point,tempNode,d);
                                    tempF=zeros(6,1);
                                    tempK=zeros(6);
                                ...
                                elseif zone==2
                                    ...
                                    [Dd2x2,Ddx]=Contact_DerivativeZone2(Point,tempNode1,tempNode2);
