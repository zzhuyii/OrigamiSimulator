...
function [U,UhisLoading,loadHis,strainEnergyLoading,nodeForce,loadForce,contactForce]...
...
increStep=loadConstant(1);
    ...
    for i=1:increStep
        ...
        if contactOpen==1
            [Tcontact,Kcontact]=Contact_AssembleForceStiffness(panel0,newNode,...
                U,centerNodeStart,creaseW,newNode2OldNode,ke,d0edge,d0center,compliantCreaseOpen);
        ...
        while and(step<iterMax,R>tor)
           ...
           if contactOpen==1
                [Tcontact,Kcontact]=LockingAssemble(panel0,newNode,...
                    U,centerNodeStart,creaseW,newNode2OldNode,ke,d0edge,d0center,compliantCreaseOpen);
