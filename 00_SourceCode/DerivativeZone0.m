%% Thi function calculate the Derivative of D in Zone 0
% D is the point to triangle distance, 
% and in Zone 0 this is a point to plane distance.
...
function [Dd2x2,Ddx]=DerivativeZone0(Point,T1,T2,T3)
    Dd2x2=zeros(12,12);
    Ddx=zeros(12,1);
