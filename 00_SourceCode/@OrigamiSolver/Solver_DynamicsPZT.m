function [U,UHis]=Solver_Dynamics(obj,dynamics)
    ...
    for i=1:step
        ...
        [theta0]=obj.Spr_Theta(squeeze(UHis(1,:,:)),...
            obj.sprIJKL,obj.newNode);
        [Sx,C]=obj.Bar_Cons(obj.barType,Ex,obj.panelE,obj.creaseE);
        [M,sprKadj]=obj.Spr_Cons(targetSprZeroStrain-...
            20000*(targetSprZeroStrain-theta0).*(targetSprZeroStrain-theta0).*(targetSprZeroStrain-theta0),theta,...
