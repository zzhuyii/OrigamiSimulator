%% Solver for electro-thermal folding 
%
% This solver solves the electro-thermal folding motion of active origami
% systems. We first solve the elavated crease temperature from the applied
% heating power. Then we solve for the folded configuration of the origami
% structure. 
%
