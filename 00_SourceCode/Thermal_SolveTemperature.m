...
function [T,indexArray]=Thermal_SolveTemperature(qin,thermalMat,...
    thermalNodeNum,modelThermalConstant)

    airLayer=modelThermalConstant{6};    
    RT=modelThermalConstant{8};
    roomTempNode=modelThermalConstant{10};
    A=size(roomTempNode);
    N=A(1);
