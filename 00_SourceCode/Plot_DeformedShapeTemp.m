...
function Plot_DeformedShapeTemp(viewControl,newNode,deformNode,newPanel,...
    T,thermalBoundaryPanels,newPanel2OldPanel)
    ...
    for i=1:FaceNum
        ...
        check=0;
        for j=1:BCnum
            if newPanel2OldPanel(i)==thermalBoundaryPanels(j) && newPanel2OldPanel(i)~=0
                check=1;
            end
        end
        if check==1
