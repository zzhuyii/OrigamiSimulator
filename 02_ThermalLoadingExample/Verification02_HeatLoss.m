...
thermalConductStruct=0.3;
thermalConductEnv=0.026;
alpha=20/180*3.14;
tenv=1.5;
N=10;
W=0.4;
...
ori.panelThickMat=[tp1;tp2];
ori.panelW=W;

ori.creaseThickMat=zeros(ori.oldCreaseNum,1);
ori.creaseThickMat(3)=tc;
...
ori.panelThermalConductMat = [1;1]*thermalConductStruct; 
ori.creaseThermalConduct=thermalConductStruct;
ori.envThermalConduct=thermalConductEnv;

% thickness of the submerged environment at RT
ori.t2RTpanelMat=[1;1]*tenv; 
ori.t2RTcrease=tenv;

ori.envLayer=N;
ori.thermalDissipation=alpha;
ori.RT=0;
...
thermal.thermalBoundaryPanelMat=[-1];
thermal.roomTempNode=[1;4;6;7];

thermal.deltaAlpha=0; 
thermal.Emat1=1;
thermal.Emat2=1;
thermal.tmat1=1;
thermal.tmat2=1;
